...
bot.on('guildCreate', async (guild) => {
  await database.query(`SELECT guild_id FROM all_guild_id WHERE guild_id = ?`, [guild.id]).catch(err => {
    await database.query(`INSERT INTO all_guild_id (guild_id) VALUES (?)`, [guild.id]).catch(err => {})
  });
