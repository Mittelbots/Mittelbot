...
module.exports.run = async ({
    ...
    if(result.playlist) {
        ...
        embed
            .setDescription(`**${result.playlist.title}** with ${result.playlist.tracks.length} Songs has been added to the Queue`)
        ...
        embed
            .setDescription(`**[${result.tracks[0].title}](${result.tracks[0].url})** has been added to the Queue`)
