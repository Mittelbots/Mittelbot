...
*/
    ...
    var controller_bar = core_datasetController.extend({
        ...
        _resolveDataElementOptions: function () {
            ...
            var values = helpers$1.extend(
                {},
                core_datasetController.prototype._resolveDataElementOptions.apply(me, arguments)
            );
    ...
    var controller_bubble = core_datasetController.extend({
        ...
        _resolveDataElementOptions: function (point, index) {
            ...
            var values = core_datasetController.prototype._resolveDataElementOptions.apply(
                me,
                arguments
            );
            ...
            values.radius = resolve$1(
                [custom.radius, data.r, me._config.radius, chart.options.elements.point.radius],
                context,
                index
            );
    ...
    var controller_doughnut = core_datasetController.extend({
        ...
        update: function (reset) {
            ...
            chart.radiusLength =
                (chart.outerRadius - chart.innerRadius) / (me._getVisibleDatasetWeightTotal() || 1);
            ...
            me.outerRadius =
                chart.outerRadius - chart.radiusLength * me._getRingWeightOffset(me.index);
    ...
    var controller_line = core_datasetController.extend({
        ...
        _resolveDatasetElementOptions: function (element) {
            ...
            var values = core_datasetController.prototype._resolveDatasetElementOptions.apply(
                me,
                arguments
            );
    ...
    var core_scaleService = {
        ...
        getScaleDefaults: function (type) {
            ...
            return this.defaults.hasOwnProperty(type)
                ? helpers$1.merge(Object.create(null), [core_defaults.scale, this.defaults[type]])
                : {};
        },
            ...
            for (i = 0, ilen = body.length; i < ilen; ++i) {
                ...
                for (j = 0, jlen = lines.length; j < jlen; ++j) {
                    ...
                    if (drawColorBoxes) {
                        ...
                        ctx.fillRect(
                            rtlHelper.leftForLtr(rtlHelper.xPlus(rtlColorX, 1), bodyFontSize - 2),
                            pt.y + 1,
                            bodyFontSize - 2,
                            bodyFontSize - 2
                        );
        ...
        /** @lends Chart */ {
            ...
            resize: function (silent) {
                ...
                var newHeight = Math.max(
                    0,
                    Math.floor(
                        aspectRatio ? newWidth / aspectRatio : helpers$1.getMaximumHeight(canvas)
                    )
                );
    ...
    var core_helpers = function () {
        ...
        helpers$1._alignPixel = function (chart, pixel, width) {
            ...
            return (
                Math.round((pixel - halfWidth) * devicePixelRatio) / devicePixelRatio + halfWidth
            );
        };
    ...
    var Scale = core_element.extend({
        ...
        fit: function () {
            ...
            if (tickOpts.display && display) {
                ...
                if (isHorizontal) {
                    ...
                    me.paddingRight =
                        Math.max(
                            ((paddingRight - offsetRight) * me.width) / (me.width - offsetRight),
                            0
                        ) + 3;
                } else {
        ...
        _autoSkip: function (ticks) {
            ...
            if (numMajorIndices > 0) {
                ...
                skip(
                    ticks,
                    spacing,
                    helpers$1.isNullOrUndef(avgMajorSpacing) ? 0 : first - avgMajorSpacing,
                    first
                );
                skip(
                    ticks,
                    spacing,
                    last,
                    helpers$1.isNullOrUndef(avgMajorSpacing) ? ticks.length : last + avgMajorSpacing
                );
                return nonSkipped(ticks);
            }
            skip(ticks, spacing);
        ...
        _drawGrid: function (chartArea) {
            ...
            var axisWidth = gridLines.drawBorder
                ...
                : 0;
            var items =
                me._gridLineItems || (me._gridLineItems = me._computeGridLineItems(chartArea));
    ...
    function getTickBackdropHeight(opts) {
        ...
        if (tickOpts.display && opts.display) {
            return (
                valueOrDefault$c(tickOpts.fontSize, core_defaults.global.defaultFontSize) +
    ...
    function toTimestamp(scale, input) {
        ...
        if (!helpers$1.isFinite(value)) {
            value =
                typeof format === 'string' ? adapter.parse(value, format) : adapter.parse(value);
        }
    ...
    var scale_time = core_scale.extend({
        ...
        determineDataLimits: function () {
            ...
            if (timestamps.length) {
                timestamps =
                    ilen > 1 ? arrayUnique(timestamps).sort(sorter) : timestamps.sort(sorter);
