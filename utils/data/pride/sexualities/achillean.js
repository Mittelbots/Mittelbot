const Achillean = {
  ...
  gender: ["Men", "Men-aligned"],
  attractedTo: ["Men", "Men-aligned"],
  attractionType: "Any",
  differentFrom: ["Gay"],
  flag:
    "https://static.wikia.nocookie.net/lgbtqia-sandbox/images/a/a9/Achillean_Flag.svg/revision/latest/scale-to-width-down/350?cb=20220123044402.png",
};

module.exports = Achillean;
