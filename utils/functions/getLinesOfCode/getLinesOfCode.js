...
async function getLinesOfCode(cb) {
    const options = {
        ...
        ignorePaths: ['_logs', '.github', 'node_modules', '.bashrc', '.gitattributes', '.gitignore', 'LICENSE', 'package-lock.json', 'package.json', 'README.md', '.git', '.github', 'vendor'], // A list of directories to ignore. Supports glob patterns.
