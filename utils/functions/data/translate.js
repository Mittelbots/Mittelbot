...
class Translate {
    ...
    get(guild_id) {
        return new Promise(async (resolve, reject) => {
            ...
            if (translateConfig.translate_log_channel && translateConfig.translate_language && translateConfig.translate_target) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            .then((res) => {
                ...
                if (message.channel.id === translateConfig.translate_target) {
                    return translatte(message.content, { to: translateConfig.translate_language })
                        .then((res) => {
                            const channel = message.guild.channels.cache.find((c) => c.id === translateConfig.translate_log_channel);
                            if (channel) {
                                channel
