...
module.exports.updatePermsFromModroles = async ({guild_id, role_id, isadmin, ismod, ishelper}) => {
    return new Promise(async (resolve, reject) => {
        ...
        return await updateGuildConfig({
            ...
            resolve(`✅ ${role_id} has been updated to ${isadmin ? 'Admin' : ismod ? 'Moderator' : 'Helper'}.`);
        }).catch(err => {
