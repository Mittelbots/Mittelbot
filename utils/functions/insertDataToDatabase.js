...
function insertDataToOpenInfraction (uid, modid, mute, ban, warn, till_date, reason, infraction_id) {
    database.query('INSERT INTO open_infractions (user_id, mod_id, mute, ban, warn, till_date, reason, infraction_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',[uid, modid, mute, ban, warn, till_date, reason, infraction_id], (err) => console.log(err));
}
